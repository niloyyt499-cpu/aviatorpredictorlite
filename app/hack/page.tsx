...
const ImageWithFallback = ({ localSrc, externalSrc, alt, className }: { localSrc: string, externalSrc: string, alt: string, className: string }) => {
...
function HackIdPageComponent() {
    ...
    const handleConfirm = () => {
        ...
        if (hackId.length !== 10 || !allowedMiddleDigits.includes(middleDigits) || !isValidPattern) {
